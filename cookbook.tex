...
\Ingredient{1 szklanka letniego mleka}
...
\Ingredient{\fr12 kg mąki pszennej}
\Ingredient{\fr12 kg mąki żytniej}
...
\freeform%
Sos pomarańczowy:
\Ingredient{\fr{1}{2} szklanki wyciśniętego soku z pomarańczy}
\Ingredient{6 łyżek wody}
\Ingredient{2 łyżki jasnego sosu sojowego}
\Ingredient{3 łyżki cukru}
\Ingredient{2 łyżeczki octu ryżowego}
\Ingredient{4 łyżeczki wina Shaoxing lub wytrawnego sherry}
\Ingredient{2 łyżeczki skrobi kukurydzianej}
\Ingredient{olej chili}
...
Panierka:
\Ingredient{2 jajka}
\Ingredient{\fr{1}{2} szklanki mąki pszennej}
\Ingredient{4 łyżki skrobi kukurydzianej}
\Ingredient{\fr{1}{2} szklanki zimnej wody}
...
\Ingredient{500g mięsa z kurczaka (udka/pierś)}
\Ingredient{4 ząbki czosnku}
\Ingredient{Olej do głębokiego smażenia (rzepakowy)}
\Ingredient{Posiekany szczypiorek}
\Ingredient{Przyprażony biały sezam}
