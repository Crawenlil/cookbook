...
\textit{Ciasto kruche:}
\end{center}
\Ingredient{420g mąki pszennej} 
\Ingredient{1 płaska łyżeczka soli}
\Ingredient{2 łyżki cukru}
\Ingredient{330g masła}
\Ingredient{140ml wody}
...
\end{center}
\Ingredient{5 jabłek}
\Ingredient{35g mąki pszennej} 
\Ingredient{70g cukru}
\Ingredient{szczypta cynamonu}
...
\Ingredient{640g mąki pszennej typ 550}
\Ingredient{100g rozpuszczonego masła}
\Ingredient{250ml mleka}
\Ingredient{7g suchych drożdży}
\Ingredient{60g cukru}
\Ingredient{szczypta soli}
\Ingredient{3 jajka}
\Ingredient{sezam}

Wymieszać ze sobą mąkę, masło, mleko, drożdże, 2\fr{1}{2} jajka, cukier, sól i wyrobić. 
Ukształtować bułeczki i pozostawić do wyrośnięcia w piekarniku na 35\0C.
Posmarować bułeczki roztrzepaną \fr{1}{2} jajka i sezamem.
...
\Ingredient{500g mąki pszennej typ 550}
\Ingredient{150ml ciepłego mleka}
\Ingredient{150ml ciepłej wody}
\Ingredient{7g suchych drożdży}
\Ingredient{1 łyżeczka cukru}
\Ingredient{1 łyżeczka soli}
\Ingredient{1 jajko + odrobina wody do posmarowania}
\Ingredient{opcjonalnie ziarna do posypania (sezam, czarny sezam, czarnuszka)}
...
\Ingredient{150g boczku}
\Ingredient{1 cebula}
\Ingredient{2 łodyki selera naciowego}
\Ingredient{1 marchewka}
\Ingredient{2 łyżki oliwy}
\Ingredient{500g mielonego mięsa wołowo-wieprzowego} 
\Ingredient{1 szklanka czerwonego wina}
\Ingredient{1 bulionu}
\Ingredient{4 łyżki koncentratu pomidorowego}
\Ingredient{1 puszka krojonych pomidorów}
\Ingredient{125ml mleka}
\Ingredient{150g makaronu spaghetti}
